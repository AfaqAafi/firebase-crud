...
const Todo = ({ user }) => {
  ...
  return (
    <>
      {user ? (
        <div className="h-full pb-5 w-full bg-purple-300 flex flex-col items-center justify-center">
          <div className="bg-white fixed top-0 left-0 right-0 w-full my-5">
            <button
              onClick={handleSignout}
              className="my-4 text-center ml-2 p-2 bg-slate-300 rounded-md text-gray-500"
            >
              Sign Out
            </button>
          </div>
          <div className="min-w-[500px] bg-slate-200 h-auto pb-48 mt-32">
            <form onSubmit={handleSubmit}>
              <h1 className="text-center p-2 text-3xl text-gray-400">
                Todo App
              </h1>
                  ...
                  <div key={doc.id}>
                    <div className="w-full flex items-center justify-center gap-2 mt-10">
                      ...
                      <button
                        ...
                        className="p-1.5 bg-purple-300  rounded-lg duration-75 transition-all hover:bg-gray-300"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
